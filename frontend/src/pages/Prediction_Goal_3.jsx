...
const Prediction_Goal_3 = () => {
  ...
  const handleAnalyzeClick = () => {
    if (previewUrl) {
      // if position?.lat is undefined pass None

      navigate("/result", { state: {  file: selectedImage, image: previewUrl ,crop: crop, lat: position?.lat ?? null, lng: position?.lng ?? null } });
    }
  };
...
export default Prediction_Goal_3;