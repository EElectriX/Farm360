...
# Filter only rice
df = df[df["Crop_Type"].str.lower().str.strip() == "rice"]
...
# Save model
joblib.dump(model, "rice_crop_health_model_by_parameter.pkl")
joblib.dump(label_encoder, "rice_label_encoder_by_parameter.pkl")
